...
# Clase para manejar la calculadora de rutas
class RouteCalculator:
    ...
    def encontrar_camino(self, inicio, end):
        ...
        nodo_inicio.heurisitica = heurisitica(inicio, end)
        ...
        while lista_abierta:
            ...
            for vecino in self.get_vecinos(nodo_actual):
                ...
                if self.mapa[vecino.x, vecino.y] == 2:  
                    vecino.costo += 2
                vecino.heurisitica = heurisitica((vecino.x, vecino.y), end)
...
def main():
    ...
    route_calculator.obstaculo_agua(4)
